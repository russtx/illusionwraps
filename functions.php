...
function html5blank_nav()
{
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul id="menu_links">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        //wp_register_script('jquery.min', get_template_directory_uri() . '/assets/js/vendor/bower_components/jquery/dist/jquery.min.js', array(), '3.1.1'); // jquery
        //wp_enqueue_script('jquery.min'); // Enqueue it!
        
        //wp_register_script('jquery-ui.min', get_template_directory_uri() . '/assets/js/vendor/bower_components/jquery-ui-1.12.1/jquery-ui.min', array(), '1.12.1'); // jquery-UI
...
{
    if (in_category(3)) {
        $file = get_template_directory().'/single-cat-3.php';
        if ( file_exists($file) ) {
            return $file;
        }
    }
