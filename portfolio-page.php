	...
	<main role="main">
		...
		<section class="defaultSection">
                    <div class="second">
                        ...
                        <span class="blueLineHeader"><h4>Past Projects</h4></span>
		...
		<?php if (have_posts()): while (have_posts()) : the_post(); ?>
			...
			<!-- article -->
			<article id="post-<?php the_ID(); ?>" <?php post_class('portfolioArticle'); ?>>
				...
				<?php edit_post_link(); ?>
                                ...
                                <?php endif; ?>
                                 ...
                                 <?php $args = array( 'post_type' => 'portfolio','orderby' => 'menu_order date',	'order'   => 'DESC',  'posts_per_page' => '4' );$loop = new WP_Query( $args );while ( $loop->have_posts() ) : $loop->the_post();?>  
                                <div class="portfolioPost"> 
                                    <div class="portfolioThumb">
                                        <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_post_thumbnail('thumbnail'); // Declare pixel size you need inside the array?></a> 
                                    </div>
                                    <div class="portfolioContent">
                                        ...
                                        <?php $content = get_the_content();   $trimmed_content = wp_trim_words( $content, 20, '<a href="'. get_permalink() .'"> ...[ read more ]</a>' ); ?> 
                                         ...
                                         <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><span><p><?php  the_category(', '); // Separated by commas ?></p></span></a>
                                    </div> 
